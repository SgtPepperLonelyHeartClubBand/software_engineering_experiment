...
public class DataInitializer {
    ...
    @Bean
    CommandLineRunner initData(LocationRepository locationRepository, UserRepository userRepository) {
        return args -> {
            ...
            if (userRepository.count() == 0) {
                initUsers(userRepository, locationRepository);
            }
        };
    }
    ...
    private void initUsers(UserRepository userRepository, LocationRepository locationRepository) {
